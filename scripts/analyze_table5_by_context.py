...
from methylation_predictor.final_training import ArrayMomentMetrics, FinalTCGAMixTrainer
...
@torch.no_grad()
def evaluate_per_cpg(trainer: FinalTCGAMixTrainer, sample_ids: np.ndarray, cpg_ids: np.ndarray) -> dict[str, np.ndarray]:
    trainer.model.eval()
