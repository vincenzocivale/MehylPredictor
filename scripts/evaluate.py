...
def main():
    ...
    if args.model=="rna_methylation":
        ...
        for name in ("canonical_root","prior_cache","rna_cache","cpg_targets_dir","functional_atlas","annotation_cache"):
