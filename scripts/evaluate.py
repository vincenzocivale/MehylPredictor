...
(FeatureFusionLocusCLSModel/FeatureFusionArchitectureVariantModel, trained via
scripts/train.py's --engine matched_chr1_shared_backbone/shared_backbone) --
