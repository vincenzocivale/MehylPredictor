...
def scheduled_loss_config(config: LossConfig, epoch: int) -> LossConfig:
    ...
    separate ``ramp_loss_config`` (Stage MAS-PCC-v2), which callers select via
...
def _locus_centred_stats(
    ...
    exactly how P1-P5 gamed locus_pearson_weight (see
    docs/rna_branch_mas_pcc_experiments.md and Stage MAS-PCC screening result).
