...
class RNAMethylationTrainer:
    ...
    def __init__(
        ...
        *,
        ...
        # wandb: one run per training call, resumed later by evaluate_rna_checkpoint
        ...
        # that resume. `track=False` is used by evaluate_rna_checkpoint's own scratch
    ...
    def run(self) -> dict[str, object]:
        ...
        if self.wandb_run is not None:
            ...
            # anyone inspecting it before evaluation runs. evaluate_rna_checkpoint
